...
public class Main {
	...
	public static void main(String[] args) {
		...
		String centroidPath = path + File.separator + "stt_input" + File.separator + "centroids.shp";
		System.out.println("Vérification du chemin : " + centroidPath);
		File centroidFile = new File(centroidPath);
		System.out.println("Le fichier existe ? : " + centroidFile.exists());

		// layer 1 - points
		ListLayer l1 = ListLayer.readFromShapefile(
				path + File.separator + "stt_input" +  File.separator + "centroids.shp", Color.DARK_GRAY);
		...
		g.exportClustersAsMultipoints(path + File.separator + "stt_input" + File.separator + "multipoints.shp");
		g.exportClusterEdges(path + File.separator + "stt_input" + File.separator + "clusteredges.shp");
		g.exportEdges(path + File.separator + "stt_input" + File.separator + "graphedges.shp");
		g.exportClustersAsConvexHulls(path + File.separator + "stt_input" + File.separator + "hulls.shp");
		g.exportClustersAsVoronoiCells(path + File.separator + "stt_input" + File.separator + "cells.shp");
